...
\begin{table}[h]
\centering
\caption{Mediciones realizadas con el Osciloscopio (mV)}
...
\begin{table}[h]
\centering
\caption{Mediciones realizadas con el Multímetro (MMD) (mV)}
...
\section{Discusión}
Se observa que a altas frecuencias (mayores a 100 kHz), el multímetro pierde precisión significativamente comparado con el osciloscopio, lo cual es de esperar por el ancho de banda del instrumento.
